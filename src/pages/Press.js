      ...
      const press = 
            <div>
              ...
              <div className="press-item">
                ...
                <img className="transparent" width="83%" style={{ marginTop: '10%', zIndex: 5 }} src={ require('../images/pressV2/05/01.jpg') } />
              ...
              <div className="press-item">
                ...
                <img className="parallax transparent layer-2" width="58%" style={{ marginTop: '28%' }} src={ require('../images/pressV2/06/text.png') } />
              ...
              <div className="press-item">
                ...
                <img width="83%" style={{ marginTop: '', zIndex: 0 }} src={ require('../images/pressV2/07/05.jpg') } />
              ...
              <div className="press-item">
                ...
                <br/>
                <img className="" width="78%" style={{ marginLeft: '6%', marginTop: '-5%' }} src={ require('../images/pressV2/08/03.jpg') } />
              ...
              <div className="press-item">
                ...
                <img className="layer-1" width="95%" style={{ marginTop: '28%' }} src={ require('../images/pressV2/09/02.jpg') } />
                <img className="parallax transparent layer-2" width="86%" style={{ marginLeft: '-9%', marginTop: '1%', zIndex: 25 }} src={ require('../images/pressV2/09/01.png') } />
              ...
              <div className="press-item">
                ...
                <img className="parallax layer-2" width="34%" style={{ marginLeft: '54%', marginTop: '35%', zIndex: 25 }} src={ require('../images/pressV2/10/03.png') } />
                <img className="layer-1" width="100%" style={{marginLeft: '-4%' }} src={ require('../images/pressV2/10/02.jpg') } />
                
              </div>

              <div className="press-item">

                <img className="parallax layer-1" width="95%" style={{ zIndex: 0 }} src={ require('../images/pressV2/11/03.jpg') } />
              ...
              <div className="press-item">
                ...
                <img className="parallax layer-2" width="60%" style={{ marginTop: '40%', marginLeft: '4%' }} src={ require('../images/pressV2/12/03.png') } />

                <img className="parallax layer-1" width="50%" style={{ marginTop: '30%', marginLeft: '32%' }} src={ require('../images/pressV2/12/04.png') } />

                <img className="" width="78%" style={{ position: 'relative', zIndex: 0 }} src={ require('../images/pressV2/12/02.png') } />


                <img className="" width="75%" style={{ }} src={ require('../images/pressV2/12/05.png') } />
